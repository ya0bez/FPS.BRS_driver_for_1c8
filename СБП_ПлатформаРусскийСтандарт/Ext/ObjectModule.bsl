...
Функция КонструкторПараметровЗаписиЛогирования(
		Операция = "", ВходящиеДанные = Неопределено, РезультатВыполнения = Неопределено, Заголовок = "")
...
Процедура ВыполнитьЗаписьЛогаПриОшибки(ИнформацияОбОшибке) Экспорт
	...
	ПараметрыЗаписиЛогирования = КонструкторПараметровЗаписиЛогирования("Обработка непредвиденной ошибки",,
		Новый Структура("ИмяМодуля,ИсходнаяСтрока,Код,НомерСтроки,Причина,Описание,ДополнительнаяИнформация",
...
Процедура ВыполнитьЗаписьЖурналаРегистрацииПриОшибки(ИнформацияОбОшибке) Экспорт
	...
	ЗаписьЖурналаРегистрации(
		ИмяСобытия, УровеньЖурналаРегистрации.Ошибка, , ЭтотОбъект.Метаданные().ПолноеИмя(), Комментарий);
